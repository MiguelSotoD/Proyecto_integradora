...
$sql = "SELECT ID_proveedor, nombre_proveedor, direccion_proveedor, telefono, foto FROM proveedor WHERE activo = 1";
...
if ($resultado->num_rows > 0) {
    ...
    while ($row = mysqli_fetch_assoc($resultado)) {
     ...
     <div class="ordenes-ingresar">
        ...
        <div class="ordenes-ingresar">
            <div class="ordenes-ingresar-contenido">
                <a href="proveedorNuevo.php"><i class="icon-agregar"></i></a>
                <p>Nuevo Proveedor</p>
            </div>  
        </div>
    </section>
                            ...
                            <div class="col">
                                <div class="card shadow-sm">
                                    ...
                                    if ($row['foto'] != 'img_producto.png') {
                                        $foto = '../img/proveedores/' . $row['foto'];
                                    } else {
                                        $foto = '../img/proveedores/img_producto.png';
                                    }
                                    ?>
                                    <img src="<?php echo $foto; ?>" alt="">
                                    <div class="card-body">
                                        <p class="card-text">
                                        <h2 class="nombre-text">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <?php if($privilegio=="Administrador" ) { ?>
                                                <form action="modificarProveedor.php" method="GET">
                                                    <!-- Agrega un campo oculto para enviar el valor de ID de la orden y source -->
                                                    <input type="hidden" name="id_proveedores"
                                                        value="<?php echo $row['ID_proveedor']; ?>">
                                                    <input type="hidden" name="source" value="proveedor.php">
                                                    <button type="submit" class="btn btn-sm btn-outline-primary">Modificar</button>
                                                </form>
                                                <?php include_once('eliminarProveedor.php'); ?>
                                                <!-- Botón para redireccionar a eliminar-cliente.php -->
                                                <form class="eliminarProveedor" action="eliminarProveedor.php" method="GET">
                                                    <!-- Agrega un campo oculto para enviar el valor de ID de la orden y source -->
                                                    <input type="hidden" name="id_proveedores"
                                                        value="<?php echo $row['ID_proveedor']; ?>">
                                                    <input type="hidden" name="source" value="proveedor.php">
...
<section class="ordenes1">
     ...
     <div class="ordenes-ingresar">
            <div class="ordenes-ingresar-contenido">
                <a href="inventarioMenu.php"><i class="icon-angle-circled-left"></i></a>
                <p>Regresar</p>
            </div>  
        </div>
        <!-- Seccion de Barra de Busqueda para las Ordenes -->
        <div class="ordenes-container">
            <div class="ordenes-container-busqueda active">
                <form action="" method="post" autocomplete="off">
                    <input type="t" name="bur" id="tic" class="f" placeholder="Buscar Proveedores ...">
                    <a href="#" target="_blank">
                        <i class="icon-search icono"></i>
                    </a>
                </form>
        ...
        <section class="section-productos col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="section-producto-empty col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 file-empty">
                    ...
                    <p>No se ha encontrado ningún proveedor. ¡Creemos uno! Realice un seguimiento de sus existencias creando
